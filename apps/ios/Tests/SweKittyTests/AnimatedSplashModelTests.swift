...
struct AnimatedSplashModelTests {
    ...
    @Test func crossFadeDurationMatchesSweKittyAppEnvelope() {
        // SweKittyApp drives the dismissal with .easeOut(duration:)
    ...
    @Test func wordmarkIsLowercaseKebab() {
        // The product is consistently rendered "swe-kitty" in copy.
        // A regression to "SweKitty" or "SWE Kitty" on the splash
        // would be jarring on first launch.
        #expect(AnimatedSplashModel.wordmark == "swe-kitty")
    }
