...
struct SessionNamingTests {
    ...
    @Test func hidesEphemeralWorkDir() {
        #expect(SessionNaming.meaningfulWorkingDir("/root/.swe-kitty/sessions/abc-123/work") == nil)
    ...
    @Test func keepsRealWorkingDir() {
        #expect(SessionNaming.meaningfulWorkingDir("/Users/me/code/swe-kitty") == "/Users/me/code/swe-kitty")
