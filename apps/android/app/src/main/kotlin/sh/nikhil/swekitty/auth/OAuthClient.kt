 ...
 * redirects to `swekitty://oauth/<provider>/callback?code=...`. The
 * existing `MainActivity` intent filter on the `swekitty` scheme then
    ...
    val config: OAuthConfig
        get() = when (this) {
            OPENAI -> OAuthConfig(
                ...
                redirectUri = "swekitty://oauth/openai/callback",
                callbackScheme = "swekitty",
            ...
            ANTHROPIC -> OAuthConfig(
                ...
                redirectUri = "swekitty://oauth/anthropic/callback",
                callbackScheme = "swekitty",
                authorizePath = "oauth/authorize",
