...
class ParsedMarkdownCacheTest {
    ...
    @Test fun revisionIsStableForSameInputs() {
        val a = markdownRevision("hello", 16f, sh.nikhil.swekitty.AppearanceStore.FontFamily.System)
        val b = markdownRevision("hello", 16f, sh.nikhil.swekitty.AppearanceStore.FontFamily.System)
        assertEquals(a, b)
    }

    @Test fun revisionVariesWithContent() {
        val a = markdownRevision("hello", 16f, sh.nikhil.swekitty.AppearanceStore.FontFamily.System)
        val b = markdownRevision("world", 16f, sh.nikhil.swekitty.AppearanceStore.FontFamily.System)
        assertTrue(a != b)
    }

    @Test fun revisionVariesWithBodyPointSize() {
        val a = markdownRevision("hello", 16f, sh.nikhil.swekitty.AppearanceStore.FontFamily.System)
        val b = markdownRevision("hello", 22f, sh.nikhil.swekitty.AppearanceStore.FontFamily.System)
        assertTrue(a != b)
    }

    @Test fun revisionVariesWithFontChoice() {
        val a = markdownRevision("hello", 16f, sh.nikhil.swekitty.AppearanceStore.FontFamily.System)
        val b = markdownRevision("hello", 16f, sh.nikhil.swekitty.AppearanceStore.FontFamily.Monospaced)
        assertTrue(a != b)
    }
}
